...
public class Version_1_8_R1 implements SupremeText, NMS {

    @Override
    public void sendMessage(Player player, Message message) {
        IChatBaseComponent baseComponent = ChatSerializer.a(message.getJson().toJSONString());
    ...
    public void sendTitle(Player player, Title title) {
        ...
        PacketPlayOutTitle titlePacket = new PacketPlayOutTitle(
                EnumTitleAction.TITLE, titleText,fadeInTime,fadeShowTime,fadeOutTime);

        PacketPlayOutTitle subtitlePacket = new PacketPlayOutTitle(
                EnumTitleAction.SUBTITLE, subtitleText,fadeInTime,fadeShowTime,fadeOutTime);
    ...
    public void sendActionBar(Player player, String text) {
        IChatBaseComponent baseComponent = ChatSerializer.a("{\"text\":\"" + text + "\"}");
