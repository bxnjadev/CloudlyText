...
public class Version_1_16_R1 implements SupremeText, NMS {
    ...
    public void sendMessage(Player player, Message message) {
        ...
        PacketPlayOutChat packetChat = new PacketPlayOutChat(baseComponent, ChatMessageType.CHAT,player.getUniqueId());
    ...
    public void sendActionBar(Player player, String text) {
        ...
        PacketPlayOutChat packetChat = new PacketPlayOutChat(baseComponent, ChatMessageType.GAME_INFO,player.getUniqueId());
        sendPacket(player,packetChat);
    }
